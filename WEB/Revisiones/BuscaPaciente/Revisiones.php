...
<html lang="en">
 ...
 <!-- **********************   jQuery   ********************************************************** -->   
  ...
  <body >
                    ...
                    <tbody style="height: 0.8em">
                        ...
                        <tr>
                        	<form action="../SeguimientoRevision.php" method="post" >
                        		<input type="hidden" value="<?php echo ($_POST['BuscaNHC']); ?>" id="NHCSeguimiento" name="NHCSeguimiento" />
                            <td><?php echo ($_POST['BuscaNHC']);  ?></td>
                            <td><?php echo ($_POST['FechaRevision']); ?></td>
                            <td>
    ...
    <input type="hidden" id="FechaRevision" />
