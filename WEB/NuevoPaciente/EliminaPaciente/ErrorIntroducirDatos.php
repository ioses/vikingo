      ...
      <div class="hero-unit">
        <div class="row-fluid">
            <div class="span12" id="datosPaciente" name="datosPaciente" align="center">               
               <div style="font-size: 120%"> Ha habido un error al introducir el paciente <?php echo ($_SESSION["NHC"]); ?></div>
               <div style="font-size: 120%"> Si ha introducido los datos con el navegador Safari, recuerde de rellenar todos los campos</div>
                <a href="../Inicial/Inicial.php" class="btn btn-primary btn-large">Volver a Inicial</a></p>
