<?php
    ...
    //Manda el email a nosotros (proyectovikingo@proyectovikingo.es)
    $to = "info@proyectovikingo.org";
    $subject = utf8_decode($_POST['asunto']);
    $message = utf8_decode($_POST['mensaje']);
    $from = utf8_decode($_POST['username']) . "<" . $_POST['email'] . ">";
    $headers = "From:" . $from;
    ...
    <div class="container">
        <div class="hero-unit">
            <div class="row-fluid" style="text-align: center;"> 
                <h2 class="form-signin-heading">Email enviado</h2>
