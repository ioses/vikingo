...
$sqlHospital="SELECT DISTINCT HOSPITAL FROM tabla_estadistica";

$resHosp = mysqli_query($conexion,$sqlHospital) or die(mysqli_error());


while($row = mysqli_fetch_array($resHosp)) {
...
$sqlEst="SELECT * FROM tabla_estadistica WHERE HOSPITAL=".$row[0];
