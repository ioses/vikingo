...
<!---->
  <body>
   ...
   <div class="container-fluid">
                ...
                <div class="hero-unit">
                    <div class="row-fluid">             
                        <dl class="dl-horizontal-principal">
                            ...
                            <dt>
                                <label class="margen">Únicamente estoma</label>
                            </dt> 
                            <dd>
                                <dl class="dl-horizontal-secundario-mediano puntos">
                                    <dt>
                            ...
                            <dt>
                                <label class="margen">Ressección anterior</label>
                            </dt> 
                            <dd>
                                <dl class="dl-horizontal-secundario-mediano puntos">
                                    <dt>
                            ...
                            <dt>
                                <label class="margen">Mortalidad</label>
                            </dt>
                            <dd>
                                <dl class="dl-horizontal-secundario-mediano puntos">                              
                                    <dt>
     ...
     <input type="hidden" id="res_paliativa_pos3_VACIA" name="res_paliativa_pos3_VACIA"/>
...
<!--Variables por hospital-->
     ...
     <input type="hidden" id="res_paliativa_pos3_VACIA_h" name="res_paliativa_pos3_VACIA_h"/>
	 
	 <input type="hidden" id="entraTotal" name="entraTotal"/>
	 <input type="hidden" id="entraHospital" name="entraHospital"/>
	 <input type="hidden" id="adentro" name="adentro"/>
	 
	 <input type="hidden" id="hospit" name="hospit"/>
