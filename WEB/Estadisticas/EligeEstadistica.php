    ...
    <div class="container">
      ...
      <div class="hero-unit">
        <div class="row-fluid" style="text-align: center;">         
            ...
            <div class="span12">
                <div class="span5">
                    <a href="Kaplan-meier/KMpdf.php" class="btn btn-primary btn-large" style="width: 75%">
                     Análisis Kaplan-meier</a>
                ...
                <p>&nbsp;</p>
                 ...
                 <div class="span5 offset1">
                    <a href="Kaplan-meierHospital/direccionarGrafica.php" class="btn btn-primary btn-large" style="width: 75%">
                     Gráfica comparativa</a>
                </div>
           </div><!--span12-->
