...
//Hospitales (Todos o individualizado)
	...
	if ($DifSeguimientoCirugia>=$MesesMinimos){
	 ...
	 if($altura_tumor_05==null && $altura_tumor_610==null && $altura_tumor_1115==3 && $reseccion_abd==null && $reseccion_anterior==null && $hartmann==3){
		...
		if ($B_Cirugia==1 && ($CampoEstadio==0 || $CampoEstadio==1 || $CampoEstadio==2 || $CampoEstadio==3) && ($TipoRes==1 || $TipoRes==2)){
			...
			if($Localizacion==3&& $Tec_Cir==3 && $fechacorrecta==1){
				...
				if($B_Recidiva==1){
					...
					$sqlDifMeses="SELECT DATEDIFF('$Fecha_Recidiva','$Fecha_Cirugia')";
					...
					/*$sqlInsertRecidiva="INSERT INTO recidiva_kaplan_meier (Hospital, ID, Tec_Cir, Localizacion, Fecha_Cir, Fecha_Seguimiento, B_Recidiva, Fecha_Recidiva, Meses_Dif, Edad, Meso_Cal, Tto_Neo, Sexo, EstadioPato, Perforacion, Circun_Margen, Meses_Seguimiento) VALUES 
										('$Hospital','$Id_Paciente','$Tec_Cir', '$Localizacion', '$Fecha_Cirugia', '$Fecha_Revision', '$B_Recidiva', '$Fecha_Recidiva', '$DifMeses', '$Edad', '$MesoCal', '$Tto_Neo', '$Sexo', '$CampoEstadio', '$Perfora', '$M_Circun', '$DifSeguimientoCirugia') ";
				
				
				
					mysqli_query($conexion,$sqlInsertRecidiva) or die('Error: ' . mysqli_error());
				    */
				     $recidiva_kaplan_meier["Hospital"][] = $Hospital;
                     $recidiva_kaplan_meier["ID"][] = $Id_Paciente;
                     $recidiva_kaplan_meier["Tec_Cir"][] = $Tec_Cir;
                     $recidiva_kaplan_meier["Localizacion"][] = $Localizacion;
                     $recidiva_kaplan_meier["Fecha_Cir"][] = $Fecha_Cirugia;
                     $recidiva_kaplan_meier["Fecha_Seguimiento"][] = $Fecha_Revision;
                     $recidiva_kaplan_meier["B_Recidiva"][] = $B_Recidiva;
                     $recidiva_kaplan_meier["Fecha_Recidiva"][] = $Fecha_Recidiva;
                     $recidiva_kaplan_meier["Meses_Dif"][] = $DifMeses;
                     $recidiva_kaplan_meier["Edad"][] = $Edad;
                     $recidiva_kaplan_meier["Meso_Cal"][] = $MesoCal;
                     $recidiva_kaplan_meier["Tto_Neo"][] = $Tto_Neo;
                     $recidiva_kaplan_meier["Sexo"][] = $Sexo;
                     $recidiva_kaplan_meier["EstadioPato"][] = $CampoEstadio;
                     $recidiva_kaplan_meier["Perforacion"][] = $Perfora;
                     $recidiva_kaplan_meier["Circun_Margen"][] = $M_Circun;
                     $recidiva_kaplan_meier["Meses_Seguimiento"][] = $DifSeguimientoCirugia;
				
				
				}else if($B_Recidiva==2){
					...
					/*$sqlInsertRecidiva="INSERT INTO recidiva_kaplan_meier (Hospital, ID, Tec_Cir, Localizacion, Fecha_Cir, Fecha_Seguimiento, B_Recidiva, Meses_Dif, Edad, Meso_Cal, Tto_Neo, Sexo, EstadioPato, Perforacion, Circun_Margen, Meses_Seguimiento) VALUES 
										('$Hospital', '$Id_Paciente','$Tec_Cir', '$Localizacion', '$Fecha_Cirugia', '$Fecha_Revision', '$B_Recidiva', '$DifMeses', '$Edad', '$MesoCal', '$Tto_Neo', '$Sexo', '$CampoEstadio', '$Perfora', '$M_Circun', '$DifSeguimientoCirugia') ";
		...
		if ($B_Cirugia==1 && ($CampoEstadio==0 || $CampoEstadio==1 || $CampoEstadio==2 || $CampoEstadio==3) && ($TipoRes==1 || $TipoRes==2)){
			...
			if($Localizacion==2 && ($Tec_Cir==1 || $Tec_Cir==2) && $fechacorrecta==1){				if($B_Recidiva==1){
...
$_SESSION["recidiva_km"] = null;
 
$_SESSION["recidiva_km"] = $recidiva_kaplan_meier;

mysqli_close($conexion);	

if ($_SESSION["Total"]==1){
	header("Location: ../Seguimiento/CalculaSeguimiento.php");	
}else{
header("Location: ./Recidiva.php");
}	
