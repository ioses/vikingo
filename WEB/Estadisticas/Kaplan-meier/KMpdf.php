...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Proyecto Vikingo::Kaplan Meier</title>
        ...
        <div class="row-fluid" style="text-align: center;">   
			...
			<div class="alert alert-block">
				<button id="buttonDescargar" name="buttonDescargar" class="btn" type="submit" onclick="location.href='DescargaContenidoCodificaciones.php'">
					<i class=" icon-download-alt"></i>Descargar kaplan Meier en pdf
				</button>
			</div>
			
			
			
			<iframe src="http://docs.google.com/viewer?url=http%3A%2F%2Fproyectovikingo.org%2FWEB%2FCSV%2FAnalysis%2FAnalysis.pdf&embedded=true" width="850" height="1100" style="border: none;"></iframe>
