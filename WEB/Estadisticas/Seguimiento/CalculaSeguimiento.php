...
//Creamos el array
$seguimiento_kaplan_meier = array(
     "Hospital"=> array(),
     "ID"=> array(),
     "Tec_Cir"=> array(),
     "Localizacion"=> array(),
		...
		if ($B_Cirugia==1 && ($CampoEstadio==0 || $CampoEstadio==1 || $CampoEstadio==2 || $CampoEstadio==3) && ($TipoRes==1 || $TipoRes==2)){
			...
			if($Localizacion==3&& $Tec_Cir==3 && $fechacorrecta==1){
				...
				if($Vivo==2){
					...
					$sqlDifMeses="SELECT DATEDIFF('$FechaMuerte','$Fecha_Cirugia')";
					...
					/*$sqlInsertSeguimiento="INSERT INTO seguimiento_kaplan_meier (Hospital, ID, Tec_Cir, Localizacion, Fecha_Cir, Fecha_Seguimiento, B_Estado, Fecha_Muerte, Meses_Dif, Edad, Meso_Cal, Tto_Neo, Sexo, EstadioPato, Perforacion, Circun_Margen, Meses_Seguimiento) VALUES 
										('$Hospital', '$Id_Paciente','$Tec_Cir', '$Localizacion', '$Fecha_Cirugia', '$Fecha_Revision', '$Vivo', '$FechaMuerte', '$DifMeses', '$Edad', '$MesoCal', '$Tto_Neo', '$Sexo', '$CampoEstadio', '$Perfora', '$M_Circun', '$DifSeguimientoCirugia') ";
				
				
				
					mysqli_query($conexion,$sqlInsertSeguimiento) or die('Error: ' . mysqli_error());
				*/
				
				     $seguimiento_kaplan_meier["Hospital"][] = $Hospital;
                     $seguimiento_kaplan_meier["ID"][] = $Id_Paciente;
                     $seguimiento_kaplan_meier["Tec_Cir"][] = $Tec_Cir;
                     $seguimiento_kaplan_meier["Localizacion"][] = $Localizacion;
                     $seguimiento_kaplan_meier["Fecha_Cir"][] = $Fecha_Cirugia;
                     $seguimiento_kaplan_meier["Fecha_Seguimiento"][] = $Fecha_Revision;
                     $seguimiento_kaplan_meier["B_Estado"][] = $Vivo;
                     $seguimiento_kaplan_meier["Meses_Dif"][] = $DifMeses;
                     $seguimiento_kaplan_meier["Edad"][] = $Edad;
                     $seguimiento_kaplan_meier["Meso_Cal"][] = $MesoCal;
                     $seguimiento_kaplan_meier["Tto_Neo"][] = $Tto_Neo;
                     $seguimiento_kaplan_meier["Sexo"][] = $Sexo;
                     $seguimiento_kaplan_meier["EstadioPato"][] = $CampoEstadio;
                     $seguimiento_kaplan_meier["Perforacion"][] = $Perfora;
                     $seguimiento_kaplan_meier["Circun_Margen"][] = $M_Circun;
                     $seguimiento_kaplan_meier["Meses_Seguimiento"][] = $DifSeguimientoCirugia;
					...
					/*$sqlInsertSeguimiento="INSERT INTO seguimiento_kaplan_meier (Hospital, ID, Tec_Cir, Localizacion, Fecha_Cir, Fecha_Seguimiento, B_Estado, Meses_Dif, Edad, Meso_Cal, Tto_Neo, Sexo, EstadioPato, Perforacion, Circun_Margen, Meses_Seguimiento) VALUES 
										('$Hospital', '$Id_Paciente','$Tec_Cir', '$Localizacion', '$Fecha_Cirugia', '$Fecha_Revision', '$Vivo', '$DifMeses', '$Edad', '$MesoCal', '$Tto_Neo', '$Sexo', '$CampoEstadio', '$Perfora', '$M_Circun', '$DifSeguimientoCirugia') ";
...
$_SESSION["seguimiento_km"] = null;
$_SESSION["seguimiento_km"] = $seguimiento_kaplan_meier;

/*foreach ($_SESSION["seguimiento_km"] as $clave=>$valorArray)
{
