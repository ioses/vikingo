...
$a=array(
    ...
    "O_H_neo_III"=>number_format((($O_H_neo_III/$H_III_total)*100), 2, '.', ''),
    "O_H_neo_T4"=>number_format((($O_H_neo_T4/$H_IV_total)*100), 2, '.', ''),       
    "O_H_ady"=>number_format((($O_H_ady/$H_ady_total)*100), 2, '.', ''),
    "O_H_ady_I"=>number_format((($O_H_ady_I/$H_I_total)*100), 2, '.', ''),       
    "O_H_ady_II"=>number_format((($O_H_ady_II/$H_II_total)*100), 2, '.', ''),         
    "O_H_ady_III"=>number_format((($O_H_ady_III/$H_III_total)*100), 2, '.', ''),        
    "O_H_ady_IV"=>number_format((($O_H_ady_IV/$H_IV_total)*100), 2, '.', ''),        
