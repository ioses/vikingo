      ...
      <div class="hero-unit">
        <div class="row-fluid" style="text-align: center;">   
			...
			<div class="alert alert-block">
				<button id="buttonDescargar" name="buttonDescargar" class="btn" type="submit" onclick="location.href='DescargaContenidoCodificaciones.php?ruta=<?php echo $_GET['ruta']?>'">
					<i class=" icon-download-alt"></i>Descargar
				</button>
			</div>
			
			<iframe src="http://docs.google.com/viewer?url=<?php echo $_GET['ruta']?>&embedded=true" width="850" height="1100" style="border: none;"></iframe>
