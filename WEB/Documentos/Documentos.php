    ...
    <div class="container">
      ...
      <div class="hero-unit">
        <div class="row-fluid" style="text-align: center;">         
            ...
            <div class="span12">
                <div class="span5">
                    <a href="Restricciones/Restricciones.php" class="btn btn-primary btn-large" style="width: 75%">
                     Restricciones</a>
					 <p>&nbsp;</p>
                     <p>&nbsp;</p>
					<a href="ManualUsuario/EligeManual.php" class="btn btn-primary btn-large" style="width: 75%">
                     Manual de usuario</a>
                </div>
                <div class="span5 offset1">
                    <a href="Codificaciones/Codificaciones.php" class="btn btn-primary btn-large" style="width: 75%">
                     Codificaciones</a>
                </div>
           </div><!--span12-->
       </div><!--row-fluid-->
