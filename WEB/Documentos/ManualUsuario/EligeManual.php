    ...
    <div class="container">
      ...
      <div class="hero-unit">
        <div class="row-fluid" style="text-align: center;">         
            ...
            <div class="span12">
                <div class="span5">
                    <a href="ManualUsuario.php" class="btn btn-primary btn-large" style="width: 75%">
                     Video</a>
                </div>
                <div class="span5 offset1">
                    <a href="ManualUsuarioDocumento.php" class="btn btn-primary btn-large" style="width: 75%">
                     Documento</a>
                </div>
           </div><!--span12-->
       </div><!--row-fluid-->
