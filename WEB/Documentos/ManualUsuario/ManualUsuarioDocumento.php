      ...
      <div class="hero-unit">
        <div class="row-fluid" style="text-align: center;">   
			...
			<div class="alert alert-block">
				<button id="buttonDescargar" name="buttonDescargar" class="btn" type="submit" onclick="location.href='DescargaContenido.php'">
					<i class=" icon-download-alt"></i>Descargar manual en pdf
				</button>
			</div>

            <iframe src="http://docs.google.com/viewer?url=http%3A%2F%2Fproyectovikingo.es%2FWEB%2FDocumentos%2FManualUsuario%2FManual%20de%20usuario.pdf&embedded=true" width="800" height="1100" style="border: none;"></iframe>
