      ...
      <div class="hero-unit">
      	<div class="row-fluid">
	      	<div class="span12">
	      		...
	      		?>
	      			<select name="Hospital" id="Hospital" style="width: 60%" onchange="VerUsuario();">
	      				<?php
				...
				<div class="span8">
					<input type="text" id="login" name="login" style="width: 60%" readonly />
				</div>
				<div class="span10">
				<p>&nbsp;</p>	    
				</div>
				...
				<div class="span8">
					<input type="text" id="Password" name="Password" style="width: 60%" readonly />
				</div>
				<div class="span10">
				<p>&nbsp;</p>	    
				</div>
				...
				<div class="span8">
					<input type="text" id="email" name="email" style="width: 60%" readonly />
				</div>
       ...
       <a class="btn btn-primary btn-large pull-right" href="FormPassword.php">Volver</a> 
