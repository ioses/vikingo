...
<html lang="en">
 ...
 <!-- **********************   jQuery   ********************************************************** -->   
  ...
  <body>
      ...
      <div class="hero-unit">
        <div class="row-fluid" style="text-align: center">
            <div class="span12">
	      		...
	      		?>
	      			<select name="Hospital" id="Hospital" style="width: 50%" onchange="showNHC();">
	      				<?php
    ...
    <!-- Ponemos las variables que nos han pasado por el filtrado en hidden -->
    <input type="hidden" id="idHospi" name="idHospi" value="<?php echo $_GET["idHospi"]; ?>"/>
    <input type="hidden" id="NHC" name="NHC" value="<?php echo $_GET["NHC"]; ?>"/>
  </body>
</html>
