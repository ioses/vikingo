  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="hero-unit" style="text-align: center">
      	El paciente con NHC <?php echo($_SESSION["NHCRevision"]); ?> ha sido revisado satisfactoriamente
      	<p>&nbsp;<p/>
       <a href="Revisiones.php" class="btn btn-primary btn-large">Aceptar</a></p>
       <p>&nbsp;</p>
       <p>&nbsp;</p>
