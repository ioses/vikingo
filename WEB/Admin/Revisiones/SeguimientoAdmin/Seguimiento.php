  ...
  <body onload="HabilitarMuerte();">
			...
			<div class="container-fluid" style="width: 90%">
				...
				<div class="nav-collapse">
            	   ...
            	   <p class="navbar-text" style="color: #FFFFFF; font-size: 1.5em; text-align: center  ">
                        <?php
            		if (isset($_SESSION["NHCRevision"])){
            		echo ("NHC: ".$_SESSION["NHCRevision"]);
            		}
					?>
	...
	<div class="container-fluid">
		...
		<div class="span2">
			...
			<input type="date" name="Fecha_Revision_Menu" id="Fecha_Revision_Menu" placeholder="aaaa-mm-dd" style="position: fixed; margin-top: 390px; left:10px; width: 150px;" required onchange/>
		...
		<div class="span10" name="general">
			...
			<input type="date" name="Fecha_Revision" id="Fecha_Revision" placeholder="aaaa-mm-dd" required/>
				...
				<div class="row-fluid">
					...
					<div class="span10">
						<div class="span12">
							...
							<div class="span6"><!--INPUTS-->
								<input type="date" name="Fecha_Metastasis" id="Fecha_Metastasis" placeholder="aaaa-mm-dd" style="margin-bottom: 20px;" disabled required/>
							</div><!--/span6 INPUTS-->
						</div><!--/span12-->
				...
				<div class="row-fluid">
					...
					<div class="span10">
						<div class="span12">
							...
							<div class="span6"><!--INPUTS-->
								<input type="date" name="Fecha_Segundo_Tumor" id="Fecha_Segundo_Tumor" placeholder="aaaa-mm-dd" style="margin-bottom: 20px;" disabled required/>
							</div><!--/span6 INPUTS-->
						</div><!--/span12-->
							...
							<div class="span6">
								...
								<div class="span10">
									<div class="span12">
										...
										<div class="span6"><!--INPUTS-->
											<input type="date" name="Fecha_Muerte" id="Fecha_Muerte" placeholder="aaaa-mm-dd" style="margin-bottom: 20px;" disabled required/>
										</div><!--/span6 INPUTS-->
									</div><!--/span12-->
									
									<div class="span12">
										<div class="span4"><!--LABELS-->
											<label class="labelGrado2 labelRadio">Exitus relacionado con el cáncer</label>
										</div><!--/span4 LABELS-->
										<div class="span1">
										</div>
