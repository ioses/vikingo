<?php
  ...
  session_start();
	...
	$sqlIdentPaciente="SELECT ID FROM identificador_paciente WHERE NHC = AES_ENCRYPT('$NHC','$claveNHC') AND Id_Hospital = '$idHospital'";
...
header("Location: ./SeguimientoAdmin/Seguimiento.php");
