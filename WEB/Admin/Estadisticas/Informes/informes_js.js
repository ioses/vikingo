...
$(document).ready(function() {
    ...
    CargarDatosHospital(document.getElementById("Hospital").value, document.getElementById("inicio").value, document.getElementById("fin").value);

    //CargarDatosTotal(document.getElementById("inicio").value, document.getElementById("fin").value);
   ...
   // CargarDatosTotalCirugia(document.getElementById("inicio").value, document.getElementById("fin").value);
    ...
    // $('#barra').load(function(){
        ...
        // {
            // alert("Entra");
            // $('#barra').hide();
             // document.getElementById("alertCargando").style.visibility = 'hidden';
        // }   
//     
    // });
...
function CargarDatosHospital(hospital, fecha_inicio, fecha_fin) {
    var xmlhttp;
    ...
    xmlhttp.open("GET", "getDatosInformesHospital.php?Hospital=" + hospital + "&fecha_inicio=" + fecha_inicio + "&fecha_fin=" + fecha_fin, true);
    xmlhttp.send();
}

/*function CargarDatosTotal(fecha_inicio, fecha_fin) {
    var xmlhttp;
    ...
    xmlhttp.open("GET", "getDatosInformesTotal.php?fecha_inicio=" + fecha_inicio + "&fecha_fin=" + fecha_fin, true);
    xmlhttp.send();
}*/
...
/*function CargarDatosTotalCirugia(fecha_inicio, fecha_fin) {
    var xmlhttp;
    ...
    xmlhttp.open("GET", "getDatosInformesTotalCirugia.php?fecha_inicio=" + fecha_inicio + "&fecha_fin=" + fecha_fin, true);
    xmlhttp.send();
}*/
...
function dimension(w, h) {
    var world = document.getElementById('graphics');
