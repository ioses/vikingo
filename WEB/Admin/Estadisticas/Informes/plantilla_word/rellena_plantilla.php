...
$sqlHospital = "SELECT * FROM tabla_hospital
                WHERE Codigo = '$id_hospital'";
...
if ($exite > 0) //Hay datos, miramos si tiene las variables de los informes
{
    ...
    {
        $nombre_hospital = $rowHospital["Nombre"];
    }
}
...
/****************** DATOS GENERALES ***************************/
 ...
 /****************** DATOS GENERALES HOSPITAL***************************/

 $numero_pacientes_h = $_POST["numero_pacientes_h"];
 
 $reseccion_local_pos2_n_h = $_POST["reseccion_local_pos2_n_h"];
 $reseccion_local_pos2_p_h = $_POST["reseccion_local_pos2_p_h"];
 
 $reseccion_recto_pos2_n_h = $_POST["reseccion_recto_pos2_n_h"];
 $reseccion_recto_pos2_p_h = $_POST["reseccion_recto_pos2_p_h"];
 
 $no_resectivos_pos2_n_h = $_POST["no_resectivos_pos2_n_h"];
 $no_resectivos_pos2_p_h = $_POST["no_resectivos_pos2_p_h"];
 
 $proctocolectomia_pos3_n_h = $_POST["proctocolectomia_pos3_n_h"];
 $proctocolectomia_pos3_p_h = $_POST["proctocolectomia_pos3_p_h"];
 $exent_pelvica_pos3_n_h = $_POST["exent_pelvica_pos3_n_h"];
 $exent_pelvica_pos3_p_h = $_POST["exent_pelvica_pos3_p_h"];
 
 $res_curativa_pos3_n_h = $_POST["res_curativa_pos3_n_h"];
 $res_curativa_pos3_p_h = $_POST["res_curativa_pos3_p_h"];
 
 $res_paliativa_pos3_n_h = $_POST["res_paliativa_pos3_n_h"];
 $res_paliativa_pos3_p_h = $_POST["res_paliativa_pos3_p_h"];
 
 $res_paliativa_pos3_M1_h = $_POST["res_paliativa_pos3_M1_h"];
 $res_paliativa_pos3_M0_R2_h = $_POST["res_paliativa_pos3_M0_R2_h"];
