...
/********************** Cargamos todas las variables ************/
	...
	$idHospital=$_POST['IdHospital'];
	 ...
	 $sqlNHC="SELECT AES_DECRYPT(NHC,'$claveNHC') FROM identificador_paciente WHERE NHC = AES_ENCRYPT('$NHC','$claveNHC') AND identificador_paciente.Id_Hospital = '$idHospital'";
    
    $row=mysqli_fetch_array(mysqli_query($conexion,$sqlNHC))
       or die('Error: ' . mysqli_error()."NHC: ".$NHC);
    ...
    /*Carga del Id del hospital al que pertenece el paciente**/
    $_SESSION["CodigoHospital"]=$rowIdentPaciente["Id_Hospital"];
...
mysqli_close($conexion);
   ...
   header("Location: ../NuevoPacienteAdmin/Inicial/Inicial.php");
