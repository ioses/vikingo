  ...
  <body >
    ...
    <div class="container">
      ...
      <div class="hero-unit">
      	<div class="row-fluid">
	      	<div class="span12">
	      	<form id="formSelectHospital" name="formSelectHospital" action="ExportacionRevisiones.php" method="post">
	      		<?php
	      			$sqlHospital="SELECT Codigo, Nombre FROM tabla_hospital";
	      				
	      			$result=mysqli_query($conexion,$sqlHospital);
	      		?>
	      			<select name="Hospital" id="Hospital" style="width: 50%">
	      				<?php
	      			...
	      			<div class="span12">
	      			<div class="span4">	
	      			<input type="submit" class="btn btn-primary btn-large" value="Exportar revisiones hospital" id="btnExportar" name="btnExportar" />
	      			</div>
	      		</form>
	      		<div class="span2">&nbsp;</div>
	      		<div class="span4">
	      		<a href="ExportacionRevisionesTodos.php" class="btn btn-primary btn-large" style="width: 65%">Revisiones</a></p>
	      		</div>
	      		</div>
