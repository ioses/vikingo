...
$sqlTablaRevisiones="SELECT id.Id_Hospital, AES_DECRYPT(id.NHC,'$claveNHC'), seg.Fecha_Revision FROM identificador_paciente id, seguimiento seg 
	      		WHERE id.Id_Hospital='$idHospital' AND id.ID=seg.Id_Paciente AND seg.B_Estado=1 AND seg.B_Imposibilidad=2 
...
header("Content-Disposition: attachment; filename=Revisiones_$idHospital.xls"); 
