  ...
  <body >
    ...
    <div class="container">
      ...
      <div class="hero-unit">
      	<div class="row-fluid">
	      	<div class="span12">
	      	<form id="formSelectHospital" name="formSelectHospital" action="ExportacionPendientes.php" method="post">
	      		<?php
	      		...
	      		?>
	      			...
	      			<div class="span12">
	      			<div class="span4">	
	      			<input type="submit" class="btn btn-primary btn-large" value="Exportar pendientes hospital" id="btnExportar" name="btnExportar" />
	      			</div>
	      		</form>
	      		<div class="span2">&nbsp;</div>
	      		<div class="span4">
	      		<a href="ExportacionPendientesTodos.php" class="btn btn-primary btn-large" style="width: 65%">Pendientes</a></p>
	      		</div>
	      		</div>
