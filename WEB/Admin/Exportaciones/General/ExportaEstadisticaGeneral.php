...
$sqlTablaGeneral="SELECT * FROM tabla_general";
...
if ($_POST["OUrologicas"] == 1)
{
	...
	//Está cambiado mecanicas por infecciosas así que se mete aqui la columna de infecciosas que
	//en realidad son las mecánicas
    $OUrologicas=$row["OUroInfecc"];
...
//Se declara para poder cogerlo en Otros Histologico
