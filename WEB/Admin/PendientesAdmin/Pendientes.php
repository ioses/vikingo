...
<html lang="en">
 ...
 <!-- **********************   jQuery   ********************************************************** -->   
    ...
    <script src="PendientesAdmin_js.js"></script>
      ...
      <div class="hero-unit">
      	<div class="row-fluid">
	      	<div class="span12">
	      		...
	      		?>
	      			<select name="Hospital" id="Hospital" style="width: 50%" onchange="selectHospital();">
	      				<?php
	      		 ...
	      		 <table class="table table-hover" style="width: 100%; text-align: center">
                    <thead style="height: 0.8em">
                    	
                    		<th style="width: 35%; text-align: left; font-size: 1.5em; vertical-align: middle">NHC</th>
                    		<th style="width: 5%; text-align: left; font-size: 1.5em; vertical-align: middle">&nbsp;</th>
                    		<th style="width: 20%;">Adyuvante</th>
                    		<th style="width: 20%;">Patológica</th>
