...
if (isset($_POST["Otras_Tecnicas"])){
    ...
    foreach ($_POST['Otras_Tecnicas'] as $Otra_Tecnica_Cirugia) {
        $Otra_Tecnica_Cirugia = $Otra_Tecnica_Cirugia;
...
/*
if (isset($_POST["Comp_Abdominales_Hemo"])){
	$Abdominales_Hemo_Abdominal=$_POST["Comp_Abdominales_Hemo"];
	$Abdominales_Hemo_Abdominal=strip_tags($Abdominales_Hemo_Abdominal);
	$Abdominales_Hemo_Abdominal=intval($Abdominales_Hemo_Abdominal);
}else{
	$Abdominales_Hemo_Abdominal=null;
}

$_SESSION["Abdominales_Hemo_Abdominal"]=$Abdominales_Hemo_Abdominal;
...
elseif ($_SESSION["Localizacion"]<=10)
{
    $_SESSION["Exeresis_Meso"] = 1;
}/*
else if (($_SESSION["Tecnicas_Cirugia"] == 3 && $_SESSION["Localizacion"]>10) || $_SESSION["Tecnicas_Cirugia"]==2){
    $_SESSION[]
}
*/
