    				        ...
    				        <dd>
								...
								<dl class="dl-horizontal-principal-mediano" style="margin-top: 50px;">
										...
										<dl class="dl-horizontal-secundario-mediano margen-bottom margen-top">
											...
											<dd>
												...
												<label for="rellenarAlta">
													<!--¿Porque esta puesto value 1 en rellenar alta?-->
									...
									<dd>
										...
										<!--<input type="text" id="Otras_Tecnicas" name="Otras_Tecnicas" disabled />--> <!--Añadir los diferentes textos ¿Cómo se hacía?-->
									...
									<dd>
									    <dl class="dl-horizontal-secundario-mediano-checkbox">
									        <dt>
                                              ...
                                              <!-- 
                                                <label for="Comp_Abdominales_Hemo">
                                                    <input type="checkbox" name="Comp_Abdominales_Hemo" id="Comp_Abdominales_Hemo" value="10" disabled/>
                                                Hemo. abdominal</label>
                                                -->
