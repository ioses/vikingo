  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="hero-unit" style="text-align: center">
      	El paciente con NHC <?php echo($_SESSION["NHC"]); ?> ha sido introducido satisfactoriamente
      	<p>&nbsp;<p/>
       <a href="../../Principal_Admin.php" class="btn btn-primary btn-large">Aceptar</a></p>
       <p>&nbsp;</p>
       <p>&nbsp;</p>
       <?php 
